...
class Trainer:
    ...
    def train(self, ingraph, accumulate=False, accumulation_steps=1):
        ...
        # Apply heavy angular velocity penalty to force rotational convergence
        raw_loss = loss1 +  loss2 + loss3
        
        # Scale loss for gradient accumulation (so the sum acts as a mathematical average of the large batch)
